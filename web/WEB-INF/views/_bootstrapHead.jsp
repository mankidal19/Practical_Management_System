...
<!-- Tell the browser to be responsive to screen width -->
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/Source_Files/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/Source_Files/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
