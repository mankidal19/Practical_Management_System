<%-- 
    Document   : jsp_template_dashboard
    Created on : Nov 21, 2017, 9:46:02 AM
    Author     : NURUL AIMAN
--%>
...
<html>
    <head>
        ...
        <title>JSP skeleton dashboard</title>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href=""><i class="fa fa-circle-o"></i> View Coordinators List</a></li>
                            </ul>
                        </li>
